...
os.environ['CUDA_VISIBLE_DEVICES'] = conf.get("syn", "client2_CUDA_VISIBLE_DEVICES")
...
def send_message(thread_name):
    ...
    client2_sample_number = int(conf.get("syn", "client2_sample_number"))
...
if __name__ == '__main__':
    ...
    #     # 创建线程
    #     try:
    #         t = threading.Thread(target=send_message, args=("t2-" + str(i+1),))
    #         t.start()
    #     except:

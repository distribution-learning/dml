...
os.environ['CUDA_VISIBLE_DEVICES'] = conf.get("syn", "client4_CUDA_VISIBLE_DEVICES")
...
def send_message(thread_name):
    ...
    client4_sample_number = int(conf.get("syn", "client4_sample_number"))
...
if __name__ == '__main__':
    ...
    #     # 创建线程
    #     try:
    #         t = threading.Thread(target=send_message, args=("t4-" + str(i+1),))
    #         t.start()
    #     except:

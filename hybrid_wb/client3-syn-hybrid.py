...
os.environ['CUDA_VISIBLE_DEVICES'] = conf.get("hybrid", "client3_CUDA_VISIBLE_DEVICES")
...
def send_message(thread_name):
    ...
    client3_sample_number = int(conf.get("hybrid", "client3_sample_number"))
...
if __name__ == '__main__':
    # 设置训练超参数
    # 迭代轮次
    global_epoch = int(conf.get("hybrid", "client3_global_epoch"))
    # local_epoch = 10
    ...
    HOST, PORT = conf.get("hybrid", "server_ip_syn2"), int(conf.get("hybrid", "server_port_syn2"))
    # 存储每轮全局迭代的中间结果

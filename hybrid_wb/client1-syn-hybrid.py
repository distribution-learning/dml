...
os.environ['CUDA_VISIBLE_DEVICES'] = conf.get("hybrid", "client1_CUDA_VISIBLE_DEVICES")
...
def send_message(thread_name):
    ...
    client1_sample_number = int(conf.get("hybrid", "client1_sample_number"))
...
if __name__ == '__main__':
    # 设置训练超参数
    # 迭代轮次
    global_epoch = int(conf.get("hybrid", "client1_global_epoch"))
    # local_epoch = 10
